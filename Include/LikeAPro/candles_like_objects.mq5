...
void OnTick()
  {
   if(new_candle(PERIOD_H4))
     {
      dashboard.add_log("New H4 candle!");
      Candle c1(4);
      Candle c2(5);

      dashboard.add_log("Candle 1 Open time is "+ (string)c1.time);
      dashboard.add_log("Candle 1 High is "+ (string)c1.high);
      dashboard.add_log("Candle 1 Low is "+ (string)c1.low);
      
      dashboard.add_log("Candle 2 Open time is "+ (string)c2.time);
      dashboard.add_log("Candle 2 High is "+ (string)c2.high);
      dashboard.add_log("Candle 2 Low is "+ (string)c2.low);
      dashboard.add_log("------------------");
     }
  }
//+------------------------------------------------------------------+
